...
public class RideHistroyFragment extends android.support.v4.app.Fragment {

    private static final String EXTRA_TEXT = "text";

    public static RideHistroyFragment createFor(String text) {
        RideHistroyFragment fragment = new RideHistroyFragment();
